...
{
    return service_nvm_get_low_datarate_optimize_from_nvm();
}

int32_t service_lora_p2p_set_low_datarate_optimize(bool lowDatarateOptimize)
{
    uint32_t udrv_ret;
    udrv_ret = service_nvm_set_low_datarate_optimize_to_nvm(lowDatarateOptimize);
    return udrv_ret;
}

bool service_lora_p2p_get_crcon(void)
{
    return service_nvm_get_crc_on_from_nvm();
}
...
{
    return service_nvm_get_payloadlen_from_nvm();
}

int32_t service_lora_p2p_set_payloadlen(uint8_t payloadlen)
{
    uint32_t udrv_ret;
    udrv_ret = service_nvm_set_payloadlen_to_nvm(payloadlen);
    return udrv_ret;
}
